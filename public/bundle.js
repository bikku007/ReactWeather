...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nav = function Nav() {
	  return React.createElement(
	    ...
	    React.createElement(
	      IndexLink,
	      { to: '/', activeClassName: 'active', activeStyle: { fontWeight: 'bold', fontColor: 'Green' } },
	      'Get Weather component'
	    ),
	    React.createElement(
	      Link,
	      { to: '/about', activeClassName: 'active', activeStyle: { fontWeight: 'bold', fontColor: 'Green' } },
	      'About'
	    ),
	    React.createElement(
	      Link,
	      { to: '/examples', activeClassName: 'active', activeStyle: { fontWeight: 'bold', fontColor: 'Green' } },
	      'Examples'
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=9efb5b4cd3995eb421da2d9352a41cf1&units=metric';
